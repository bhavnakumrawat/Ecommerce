...
const ProductAddScreen = ({ match, history }) => {
  ...
  const [errorStaus, setErrorStatus] = useState(false)
  ...
  const submitHandler = (e) => {
    e.preventDefault()
    if(!name&!price&!image&!brand&!category&!description&!countInStock) return setErrorStatus(true)
    else{
      ...
      <FormContainer>
        ...
        {loading ? (
          ...
          <Form onSubmit={submitHandler}>
           {errorStaus && <Message variant='danger'>All the fields required!</Message>}
            ...
            <Button type='submit' variant='primary'variant='custom'>
              Update
            </Button>
          </Form>
        )}
